...
namespace TinySTL {
    ...
    OI adjacent_difference(II first, II last,OI result) {
        ...
        return adjacent_difference(first, last, result, TinySTL::minus<value_type>{});
	}
	...
	OI adjacent_difference(II first, II last, OI result,
        ...
        typename TinySTL::iterator_traits<II>::value_type val=*first;
	...
	constexpr auto inner_product(II_1 first1, II_1 last1,
        ...
        using T1=typename TinySTL::iterator_traits<II_1>::value_type;
        using T2=typename TinySTL::iterator_traits<II_2>::value_type;
